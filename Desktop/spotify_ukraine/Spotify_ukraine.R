...
# Read in data
spotify <- read.csv("/Users/hannah/Desktop/spotify_ukraine/Spotify_nationality - Sheet1.csv")
...
ggplot(long_monthly_spotify, aes(x = Month, y = Nationality, fill = Count)) +
  ...
  labs(
    title = "Monthly Nationality Counts Heatmap",
    x = "Month",
    y = "Nationality",
    fill = "Count"
  ) +
  theme_minimal() +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, family = "Avenir", color = "black", size = 8),  
    axis.text.y = element_text(family = "Avenir", color = "black", size = 8),  
    axis.title.x = element_text(family = "Avenir", color = "black", size = 10),  
    axis.title.y = element_text(family = "Avenir", color = "black", size = 10),  
    panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(), 
    plot.title = element_text(hjust = 0, size = 14, family = "Avenir", color = "black"),  
    legend.position = "bottom",  
    legend.text = element_text(color = "black", family = "Avenir", size = 8),  
    legend.title = element_text(color = "black", family = "Avenir", size = 10), 
...
ggplot(long_spotify, aes(x = as.Date(paste0(Month, "-01")), y = Count, group = Nationality)) +
